...
var ReportService = /** @class */ (function (_super) {
    ...
    function ReportService(http, messageService) {
        var _this = _super.call(this, http, messageService) || this;
        _this.http = http;
        _this.messageService = messageService;
        _this.apiName = 'report';
        _this.reports = null;
        return _this;
    }
    ReportService.prototype.getApiName = function () {
        return this.apiName;
    };
    ...
    ReportService.prototype.getData = function (report, parameters) {
        var _this = this;
